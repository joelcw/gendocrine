...
\end{center}
\begin{wraptable}{l}{12.5cm} % Left or right alignment is specified in the first bracket, the width of the table is in the second
\begin{tabular}{l c}
\toprule
...
\end{itemize}
%insert picture of the new task
\begin{itemize}
